...
public class ActivityMain2BindingImpl extends ActivityMain2Binding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.button_end, 2);
    }
    // views
    @NonNull
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((uk.ac.shef.oak.com4510.view_model.InsertVisitsViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable uk.ac.shef.oak.com4510.view_model.InsertVisitsViewModel ViewModel) {
