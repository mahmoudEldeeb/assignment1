...
public class Barometer {
    ...
    // The app tracks barometric pressure at regular intervals 20 seconds
    ...
    /**
     * this is used to stop the barometer if we have not seen any movement in the last 200 seconds
     */
            ...
            mPressureListener = new SensorEventListener() {
                ...
                public void onSensorChanged(SensorEvent event) {
                    ...
                    if (diff >= mSamplingRateNano) {
                        ...
                        Log.i(TAG, Utilities.mSecsToString(actualTimeInMseconds) + ": current barometric pressure: " + pressureValue + " with accuracy: " + accuracy);
