...
public class Accelerometer {
    ...
    public Accelerometer(Context context, Barometer barometer, Temperature temperature) {
            ...
            mAccelerationListener = new SensorEventListener() {
                ...
                public void onSensorChanged(SensorEvent event) {
                    ...
                    if (deltaX > 0 || deltaY > 0 || deltaZ > 0) {
                        ...
                        if (!temperature.isStarted())
                            temperature.startSensingTemperature(Accelerometer.this);
